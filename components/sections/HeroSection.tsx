    ...
    <section id="inicio" className="hero-section">
      <div className="container relative z-10 grid items-center gap-10 pt-32 sm:pt-40 pb-14 lg:min-h-[100vh] lg:grid-cols-[1.15fr_0.85fr] lg:gap-14 lg:pt-36 lg:pb-16">
        ...
        <div className="hero-copy text-left flex flex-col items-start pt-3 sm:pt-0">
          ...
          {/* Paragraphs */}
          <p className="mt-5 max-w-xl text-[14px] leading-relaxed text-slate-300 text-left">
          ...
          <p className="mt-3.5 max-w-xl text-[14px] leading-relaxed text-slate-300 text-left">
          ...
          <div className="mt-6 mb-8 lg:mb-0 w-full sm:w-auto">
            <a
              href="#formulario"
              className="inline-flex w-full sm:w-auto items-center justify-center rounded-md bg-[#1d3d63] hover:bg-[#254d7d] border border-[#3b82f6]/30 px-8 py-3.5 text-[12px] font-bold uppercase tracking-widest text-white transition-all shadow-lg shadow-black/40 text-center"
